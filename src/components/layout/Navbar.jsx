  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-[#03030c]/80 backdrop-blur-md py-4 border-b border-white/5 shadow-lg shadow-blue-500/10"
    ...
    >
      <div className="container mx-auto px-6 flex justify-between items-center">
        <a href="#" className="text-2xl font-bold relative group">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400 group-hover:opacity-80 transition-opacity">
